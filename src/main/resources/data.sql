insert into BOOK(ID, NAME, PAGE, AUTHOR, GENRE) values (1, 'It', 564, 1, 3);
...
insert into AUTHOR(ID, NAME, GENRE, AGE) values (1, 'Stephen Edwin King', 3, 74);

insert into AUTHOR(ID, NAME, GENRE, AGE) values (2, 'Ю Несбё', 2, 62)
